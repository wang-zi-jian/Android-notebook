...
public class Edit extends AppCompatActivity implements OnClickListener{
    ...
    private void InitNote() {       //进行数据填装
        ...
        String name = pref.getString("name","");      //通过sharedpreferences传递作者信息
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent = getIntent();    //接受mainactivity的数据
    ...
    public void onClick(View v){
        switch (v.getId()){
            ...
            case R.id.ButtonDelete:     //将对应的id行删除
                ...
                Edit.this.setResult(RESULT_OK,getIntent());   //回传数据给mainactivity
                Edit.this.finish();
                break;
